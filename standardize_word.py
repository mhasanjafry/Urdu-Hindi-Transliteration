...
def main():
	...
	# text_file = codecs.open('platts_hindi_updated.txt', encoding='utf-8')
	# output_file = codecs.open("platts_hindi_standardized.txt", "w", "utf-8")

	# text_file = codecs.open('web.urd.full.txt', encoding='utf-8')
	# output_file = codecs.open("web.urd.full_standardized.txt", "w", "utf-8")
	text_file = codecs.open('urdu_w2c.txt', encoding='utf-8')
	output_file = codecs.open("web_urdu_full_standardized.txt", "w", "utf-8")
	...
	for line in text_file:
		...
		line = line.replace(u'\u06d4',' ').replace(u'\u2026',' ').replace(u'\u060c',' ').replace(u'\u061f',' ').replace('(', ' ').replace('!',' ').replace('.',' ').replace('?',' ').replace(';',' ')
		line = line.strip()		
