...
hindi_ipa_urdu_dict_start[u'\u0075'] = [u'\u0627\u0648',u'\u0627\u064F']  # 6 rule: beginning alif wow or alif paish
...
hindi_ipa_urdu_dict_start[u'\u006F'] = [u'\u0627\u0648']  # 10 rule: beginning alif wow else wow
hindi_ipa_urdu_dict_start[u'\u0254'] = [u'\u0627\u064E\u0648']  # 11 rule: beginning alif zabar wow
...
hindi_ipa_urdu_dict_start[u'\u0064\u0361\u0292'] = [u'\u062C']  # 8 jeem
...
hindi_ipa_urdu_dict_start[u'\u0256'] = [u'\u0688']  # 13 ddaal 
hindi_ipa_urdu_dict_start[u'\u0256\u0324'] = [u'\u0688\u06BE',u'\u0688\u06C1']  # 14 ddaal doochasmi hey or ddaal gol hey
...
hindi_ipa_urdu_dict_start[u'\u0070\u02B0'] = [u'\u0641'] # 22 pay doochasmi hey or pay gol heychanged here by Sami
...
hindi_ipa_urdu_dict_middle[u'\u0075'] = [u'\u0648',u'\u064F']  # 6 middle wow or paish
...
hindi_ipa_urdu_dict_middle[u'\u006F'] = [u'\u0648']  # 10 rule: beginning alif wow else wow
hindi_ipa_urdu_dict_middle[u'\u0254'] = [u'\u064E\u0648']  # 11 rule: middle zabar wow
...
hindi_ipa_urdu_dict_middle[u'\u0064\u0361\u0292'] = [u'\u062C']  # 8 jeem
...
hindi_ipa_urdu_dict_middle[u'\u0256'] = [u'\u0688']  # 13 ddaal 
hindi_ipa_urdu_dict_middle[u'\u0256\u0324'] = [u'\u0688\u06BE',u'\u0688\u06C1']  # 14 ddaal doochasmi hey or ddaal gol hey
...
hindi_ipa_urdu_dict_middle[u'\u028B'] = [u'\u0648']  # 29 wow
...
hindi_ipa_urdu_dict_end[u'\u028A'] = []  # 5 rule: never appears at the end
hindi_ipa_urdu_dict_end[u'\u0075'] = [u'\u0648', u'\u064F']  # 6 ending wow or paish
...
hindi_ipa_urdu_dict_end[u'\u006F'] = [u'\u0648']  # 10 rule: beginning alif wow else wow
hindi_ipa_urdu_dict_end[u'\u0254'] = [u'\u064E\u0648']  # 11 rule: end zabar wow
...
hindi_ipa_urdu_dict_end[u'\u0064\u0361\u0292'] = [u'\u062C']  # 8 jeem
...
hindi_ipa_urdu_dict_end[u'\u0256'] = [u'\u0688']  # 13 ddaal 
hindi_ipa_urdu_dict_end[u'\u0256\u0324'] = [u'\u0688\u06BE',u'\u0688\u06C1']  # 14 ddaal doochasmi hey or ddaal gol hey
...
hindi_ipa_urdu_dict_end[u'\u028B'] = [u'\u0648']  # 29 wow
...
def main():
	...
	line_number = 1
	hindi_file = codecs.open('hindi.txt', encoding='utf-8')
	...
	for hindi_line in hindi_file:
		...
		hindi_words = pd.updated_list_of_words(hindi_line)
		#hindi_line.split()
	...
	print 'Percentage Correct: ', float(correct_words)/total_words, '%'
	print 'Percentage Correct: ', float(wrong_words)/total_words, '%'
main()
