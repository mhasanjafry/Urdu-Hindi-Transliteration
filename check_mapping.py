...
def main():
	...
	text_file = codecs.open('characters.txt', encoding='utf-8')
	...
	for line in text_file:
		...
		if line[1] in urdu_character_mapping:
			print 'Old Character: ', line[1], ' and its Unicode ', repr(line[1]), ' New Character: ', urdu_character_mapping[line[1]], ' and its Unicode ', repr(urdu_character_mapping[line[1]]) 
